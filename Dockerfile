FROM alpine:3.8
LABEL maintainer="Max Wood <mwood@chanzuckerberg.com>"
...
ADD https://github.com/maxwellwood/oauth2_proxy_bearer/releases/download/v2.2/oauth2_proxy-2.2.0.linux-amd64.go1.8.1.tar.gz /tmp
